...
If the user explicitly asks for full DOCX visual QA, prefer the host agent's document-rendering workflow. On the verified development Mac, locate the current renderer dynamically and use the dedicated render venv:
