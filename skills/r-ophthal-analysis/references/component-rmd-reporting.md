...
Use headings and subheadings for study setup, package/helper setup, data import, data audit, cleaning/recoding, analytic dataset freeze, simple tables, key outcomes, figures, deeper models, interpretation notes, and appendices.
...
Show main analysis code by default. Use `echo=FALSE` for chunks that only create table footnotes, figure legends, captions, styling, inline interpretation text, or formatting glue. Keep each result adjacent to its footnote/legend and interpretation.
